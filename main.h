...
// For play.c
enum Play_Ids {ID_PLAY_BACKGROUND, ID_PLAY_PLAYER, ID_PLAY_3, ID_PLAY_2, ID_PLAY_1, ID_PLAY_GO, ID_PLAY_SCORE, ID_PLAY_OBJECT, ID_PLAY_OBJECT2, ID_PLAY_OBJECT3, ID_PLAY_OBJECT4};
